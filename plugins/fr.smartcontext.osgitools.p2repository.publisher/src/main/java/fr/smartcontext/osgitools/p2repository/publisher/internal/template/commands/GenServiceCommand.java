...
package fr.smartcontext.osgitools.p2repository.publisher.internal.template.commands;
...
import fr.smartcontext.osgitools.p2repository.publisher.template.commands.Command;
...
public class GenServiceCommand extends Command {
	...
	/**
	 * {@inheritDoc}
	 * @see fr.smartcontext.osgitools.p2repository.publisher.template.commands.Command#execute(fr.smartcontext.osgitools.p2repository.publisher.template.ProcessingContext)
	 */
	@Override
